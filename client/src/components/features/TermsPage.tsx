  ...
  return (
    <div className="container my-5">
      ...
      <section className="mb-4">
        ...
        <p>
          Welcome to <strong>PlainB</strong>, your trusted electronics e-commerce platform. By using
          our website and services, you agree to comply with and be bound by these Terms &
      ...
      <section className="mb-4">
        ...
        <ul>
          ...
          <li>
            All content provided on the website is for informational purposes only and may be
      ...
      <section className="mb-4">
        ...
        <ul>
          ...
          <li>
            We accept secure online payments and all transactions must be completed before shipment.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-4">
        ...
        <ul>
          <li>
            PlainB strives to deliver products within the estimated timeframes, but delays may
            occur.
          </li>
      ...
      <section className="mb-4">
        ...
        <ul>
          <li>
            Products can be returned within 14 days of delivery, subject to our return policy.
          </li>
          <li>Refunds will be processed after verification of the returned items.</li>
          <li>
            Certain products (like opened software or perishable items) may not be eligible for
            return.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-4">
        ...
        <p>
          All content on PlainB, including images, text, logos, and product descriptions, is the
          property of PlainB or its partners. Unauthorized use is strictly prohibited.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p>
          ...
          <a href="/privacy">Privacy Policy</a>. By using PlainB, you consent to the collection and
          use of your data as outlined in our policy.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p>
          PlainB reserves the right to update or modify these Terms & Conditions at any time.
          Updated terms will be posted on this page and are effective immediately upon publication.
        </p>
      </section>
