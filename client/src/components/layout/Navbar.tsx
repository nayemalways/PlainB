              ...
              <div className="d-lg-flex">
                ...
                )}
                {
                  ...
                  isLogin() ? (
                      ...
                      <div className="btn-group">
                        ...
                        <ul className="dropdown-menu profile-dropdown">
                          <li className="">
                            <Link
                              type="button"
                              className="d-flex justify-content-around gap-2 text-center"
                              to="/profile"
                            >
                          ...
                          <li className="">
                            <Link
                              type="button"
                              className="position-relative d-flex justify-content-around gap-2 text-center"
                              to="/wish"
                            >
                          ...
                          <span>
                            <Link
                              ...
                              className="text-center d-block text-danger"
                              to="/"
                            >
                              Logout
                            </Link>
                    ...
                    <Link type="button" className="btn ms-3 btn-warning d-flex" to="/login">
                      Login
                    </Link>
                  )
                }
